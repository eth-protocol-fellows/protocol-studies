...
For contributors, we recommend focusing on specific topics contained in corresponding documents. It's best to own a single topic and work out all the details. Create a new document and add the topic to the sidebar if it's not there yet. Let others know what you are working on in the group channel and collaborate with contributors writing about related topics. 
